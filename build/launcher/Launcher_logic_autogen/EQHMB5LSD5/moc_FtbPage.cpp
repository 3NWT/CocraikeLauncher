...
#include "../../../../launcher/ui/pages/modplatform/ftb/FtbPage.h"
...
struct qt_meta_stringdata_CLASSFtbPageENDCLASS_t {};
static constexpr auto qt_meta_stringdata_CLASSFtbPageENDCLASS = QtMocHelpers::stringData(
    "FtbPage",
    "triggerSearch",
    "",
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CLASSFtbPageENDCLASS_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CLASSFtbPageENDCLASS_t qt_meta_stringdata_CLASSFtbPageENDCLASS = {
    {
        QT_MOC_LITERAL(0, 7),  // "FtbPage"
...
Q_CONSTINIT static const uint qt_meta_data_CLASSFtbPageENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject FtbPage::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_CLASSFtbPageENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSFtbPageENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSFtbPageENDCLASS_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<FtbPage, std::true_type>,
...
void FtbPage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<FtbPage *>(_o);
        (void)_t;
        switch (_id) {
...
void *FtbPage::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSFtbPageENDCLASS.stringdata0))
