...
#include "../../../../launcher/modplatform/technic/SingleZipPackInstallTask.h"
...
static constexpr auto qt_meta_stringdata_CLASSTechnicSCOPESingleZipPackInstallTaskENDCLASS = QtMocHelpers::stringData(
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CLASSTechnicSCOPESingleZipPackInstallTaskENDCLASS_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CLASSTechnicSCOPESingleZipPackInstallTaskENDCLASS_t qt_meta_stringdata_CLASSTechnicSCOPESingleZipPackInstallTaskENDCLASS = {
    {
        QT_MOC_LITERAL(0, 33),  // "Technic::SingleZipPackInstall..."
        QT_MOC_LITERAL(34, 17),  // "downloadSucceeded"
        QT_MOC_LITERAL(52, 0),  // ""
        QT_MOC_LITERAL(53, 14),  // "downloadFailed"
        QT_MOC_LITERAL(68, 6),  // "reason"
        QT_MOC_LITERAL(75, 23),  // "downloadProgressChanged"
        QT_MOC_LITERAL(99, 7),  // "current"
        QT_MOC_LITERAL(107, 5),  // "total"
        QT_MOC_LITERAL(113, 15),  // "extractFinished"
        QT_MOC_LITERAL(129, 14)   // "extractAborted"
    },
    "Technic::SingleZipPackInstallTask",
    "downloadSucceeded",
    "",
