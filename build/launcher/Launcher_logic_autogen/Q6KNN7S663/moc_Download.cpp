...
#include "../../../../launcher/net/Download.h"
...
struct qt_meta_stringdata_CLASSNetSCOPEDownloadENDCLASS_t {};
static constexpr auto qt_meta_stringdata_CLASSNetSCOPEDownloadENDCLASS = QtMocHelpers::stringData(
    "Net::Download",
    "downloadProgress",
    "",
    "bytesReceived",
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CLASSNetSCOPEDownloadENDCLASS_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CLASSNetSCOPEDownloadENDCLASS_t qt_meta_stringdata_CLASSNetSCOPEDownloadENDCLASS = {
    {
        QT_MOC_LITERAL(0, 13),  // "Net::Download"
        QT_MOC_LITERAL(14, 16),  // "downloadProgress"
        QT_MOC_LITERAL(31, 0),  // ""
        QT_MOC_LITERAL(32, 13),  // "bytesReceived"
        QT_MOC_LITERAL(46, 10),  // "bytesTotal"
        QT_MOC_LITERAL(57, 13),  // "downloadError"
        QT_MOC_LITERAL(71, 27),  // "QNetworkReply::NetworkError"
        QT_MOC_LITERAL(99, 5),  // "error"
        QT_MOC_LITERAL(105, 9),  // "sslErrors"
        QT_MOC_LITERAL(115, 16),  // "QList<QSslError>"
        QT_MOC_LITERAL(132, 6),  // "errors"
        QT_MOC_LITERAL(139, 16),  // "downloadFinished"
        QT_MOC_LITERAL(156, 17),  // "downloadReadyRead"
        QT_MOC_LITERAL(174, 11)   // "executeTask"
    },
    "Net::Download",
    "downloadProgress",
    "",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSNetSCOPEDownloadENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject Net::Download::staticMetaObject = { {
    QMetaObject::SuperData::link<NetAction::staticMetaObject>(),
    qt_meta_stringdata_CLASSNetSCOPEDownloadENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSNetSCOPEDownloadENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSNetSCOPEDownloadENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *Net::Download::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSNetSCOPEDownloadENDCLASS.stringdata0))
