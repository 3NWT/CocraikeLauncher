...
#include "../../../../launcher/minecraft/Component.h"
...
void Component::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &Component::dataChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
void *Component::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "ProblemProvider"))
        return static_cast< ProblemProvider*>(this);
